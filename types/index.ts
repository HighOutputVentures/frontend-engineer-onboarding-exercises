...
export type AnniversaryPost = Commentable & Node & Post & Reactable & {
...
export type BirthdayPost = Commentable & Node & Post & Reactable & {
...
export type BoostPost = Commentable & Node & Post & Reactable & {
...
export type BroadcastPost = Commentable & Node & Post & Reactable & {
...
export type CheckInPost = Commentable & Node & Post & Reactable & {
...
export type Holiday = Node & TimeOff & {
  __typename?: 'Holiday';
...
export type MoodPost = Commentable & Node & Post & Reactable & {
  __typename?: 'MoodPost';
  commented: Scalars['Boolean'];
  comments: CommentConnection;
  date: Scalars['DateTime'];
...
export type NewMemberPost = Commentable & Node & Post & Reactable & {
...
export type Status = Node & TimeOff & {
  __typename?: 'Status';
